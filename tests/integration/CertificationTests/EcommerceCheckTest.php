...
class ECommerceCheckTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * eBronze cannot be enabled along with eSilver/eGold
     * TODO: Remove exception assertions with eBronze account
     *
     * @expectedException        HpsGatewayException
     * @expectedExceptionMessage provided data was invalid. Check Amount
     */
