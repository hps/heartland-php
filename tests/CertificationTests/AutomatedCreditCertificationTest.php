...
class AutomatedCreditCertificationTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $chargeSvc = new HpsCreditService(TestServicesConfig::validMultiUseConfig());
        $response = $chargeSvc->charge(11.00, "usd", TestCreditCard::validMasterCreditCard(), TestCardHolder::certCardHolderShortZip());
        if ($response == null) {
            $this->fail("Response is null.");
        }
    ...
    public function testAuthAndCaptureMasterCardShortZip()
    {
        ...
        $chargeSvc = new HpsCreditService(TestServicesConfig::validMultiUseConfig());
        $response = $chargeSvc->authorize($amount, "usd", TestCreditCard::validMasterCreditCard(), TestCardHolder::certCardHolderShortZip());
    ...
    {
        $card = TestCreditCard::validMasterCreditCard();
        $card->cvv = null;
        $chargeSvc = new HpsCreditService(TestServicesConfig::validMultiUseConfig());
        $response = $chargeSvc->verify($card);
    ...
    public function testCreditReturnMasterCard()
    {
        ...
        $chargeSvc = new HpsCreditService(TestServicesConfig::validMultiUseConfig());
        $response = $chargeSvc->refund($amount, 'usd', TestCreditCard::validMasterCreditCard());
